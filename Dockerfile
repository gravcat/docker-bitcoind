...
ENTRYPOINT bitcoind
CMD -dbcache=$DBCACHE_SIZE_MB -par=$SCR_VER_THREADS -txindex -port=$BITCOIND_PORT -disablewallet -printtoconsole -server -rpcallowip=$RPC_ALLOW_IPS -rpcport=$JSONRPC_PORT -rpcthreads=$JSONRPC_THREADS
