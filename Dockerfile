...
ENTRYPOINT bitcoin -dbcache=$DBCACHE_SIZE_MB -par=$SCR_VER_THREADS -txindex -port=$BITCOIND_PORT -disablewallet -printtoconsole -server -rpcport=$JSONRPC_PORT -rpcthreads=4
